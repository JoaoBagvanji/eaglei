...
import { Info, HouseLine ,CaretDown, CaretUp, Eye ,PencilLine } from 'phosphor-react-native';
...
export default function Armazem() {
    ...
    const data = [
        {
          id: 1,
          nome: 'Armazém da Matola',
          info: 'Responsável: Hamilton Sitoe A.',
          image: require('../../assets/avatars/warehouse.png'),
          icon: <Icon as ={<PencilLine  color='#A1C861' size={16} />} />,
          icon2: <Icon as ={<Eye color='#A1C861' size={16} />} />,
        },
        {
          id: 2,
          nome: 'Armazém da Beira',
          info: 'Responsável: Mateus Macuacua',
          image: require('../../assets/avatars/warehouse.png'),
          icon: <Icon as ={<PencilLine  color='#A1C861' size={16} />} />,
          icon2: <Icon as ={<Eye color='#A1C861' size={16} />} />,
        ...
        },
        {
          ...
          info: 'Responsável: Davison Matsinhe',
          image: require('../../assets/avatars/warehouse.png'),
          icon: <Icon as ={<PencilLine  color='#A1C861' size={16} />} />,
          icon2: <Icon as ={<Eye color='#A1C861' size={16} />} />,
        ...
        info: 'Responsável: Mateus Joaquim',
        image: require('../../assets/avatars/warehouse.png'),
        icon: <Icon as ={<PencilLine  color='#A1C861' size={16} />} />,
        icon2: <Icon as ={<Eye color='#A1C861' size={16} />} />,
    ...
    <VStack flex={1} pb={6} bg="white">
        ...
        <VStack flex={1} px={6}>
            <HStack w="full" mt={8} mb={4} justifyContent="space-between" alignItems='center' flexDirection="row">
                ...
                <Icon as ={<HouseLine  color={colors.green[700]}/>} />
            </HStack>
            <View>
                <FlatList            
